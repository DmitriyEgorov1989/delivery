...
{
    public class MoveCourierHandle : IRequestHandler<MoveCourierCommand, UnitResult<Error>>
    {
        private readonly ICourierRepository _courierRepository;
        private readonly IOrderRepository _orderRepository;
        private readonly IUnitOfWork _unitOfWork;

        public MoveCourierHandle(ICourierRepository courierRepository, IUnitOfWork unitOfWork, IOrderRepository orderRepository)
        {
